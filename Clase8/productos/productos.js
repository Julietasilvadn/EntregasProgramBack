...
const obternerPorId=(peticion, respuesta) => {
...
const putId=(peticion, respuesta) => {
    const producto = peticion.body;
    const id = parseInt(peticion.params.id);
...
const deleteId=(peticion, respuesta) => {
    const producto = peticion.body;
    const id = parseInt(peticion.params.id);
    productos.deleteById(id);
    respuesta.json({
...
module.exports = {obtenerTodo, obternerPorId, post, putId, deleteId};